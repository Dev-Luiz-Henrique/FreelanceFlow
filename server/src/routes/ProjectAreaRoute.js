 ...
 */
router.get("/areas/:id", ProjectAreaController.getProjectAreaById);

/**
 * Retrieves a project area by its value.
 *
 * @route GET /areas/value/:value
 ...
 * @returns {500} If an internal server error occurs
 */
router.get("/areas/value/:value", ProjectAreaController.getProjectAreaByValue);
 ...
 * @returns {500} If an internal server error occurs
 */
router.get("/areas", ProjectAreaController.getAllProjectAreas);
